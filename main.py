...
#створюємо спрайти
player = Player('Remove-bg.ai_1711814745317.png', 5, win_height - 80, 80, 80, 0, 0)
monster1 = Enemy('monster_4.png', win_width - 80, 180, 80, 80, 5)
monster2 = Enemy('monster_4.png', win_width - 80, 100, 80, 80, 10)
...
while run:
    ...
    if not finish:
        ...
        if sprite.spritecollide(player, monsters, False):
            ...
            img = image.load('Копія _game-over_1 (1).png')
        ...
        if sprite.collide_rect(player, final_sprite):
            finish = True
            img = image.load('Копія _trophy.png')
            window.fill((255, 255, 255))
